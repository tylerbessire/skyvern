...
def upgrade() -> None:
    ...
    op.add_column(
        "task_generations", sa.Column("user_prompt_hash", sa.String(), nullable=True)
    )
    op.add_column(
        "task_generations",
    ...
    op.create_index(
        op.f("ix_task_generations_user_prompt_hash"),
        "task_generations",
        ["user_prompt_hash"],
        unique=False,
    )
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(
        op.f("ix_task_generations_user_prompt_hash"), table_name="task_generations"
    )
    op.drop_index(
        op.f("ix_task_generations_source_task_generation_id"),
    ...
    op.create_index(
        "ix_task_generations_user_prompt",
        "task_generations",
        ["user_prompt"],
        unique=False,
    )
