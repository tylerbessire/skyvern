...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "bitwarden_sensitive_information_parameter_id", sa.String(), nullable=False
        ),
        ...
        sa.Column(
            "bitwarden_client_secret_aws_secret_key", sa.String(), nullable=False
        ),
        sa.Column(
            "bitwarden_master_password_aws_secret_key", sa.String(), nullable=False
        ),
    ...
    op.create_index(
        op.f(
            "ix_bitwarden_sensitive_information_parameters_bitwarden_sensitive_information_parameter_id"
        ),
        "bitwarden_sensitive_information_parameters",
