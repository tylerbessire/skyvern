...
def upgrade() -> None:
    op.add_column(
        "workflow_runs", sa.Column("workflow_permanent_id", sa.String(), nullable=True)
    )
    op.add_column(
        "workflow_runs", sa.Column("organization_id", sa.String(), nullable=True)
    )
    ...
    op.create_foreign_key(
        "fk_workflow_runs_organization_id",
        "workflow_runs",
        "organizations",
        ["organization_id"],
        ["organization_id"],
    ...
    op.create_index(
        "ix_workflow_runs_workflow_permanent_id",
        "workflow_runs",
...
def downgrade() -> None:
    ...
    op.drop_constraint(
        "fk_workflow_runs_organization_id", "workflow_runs", type_="foreignkey"
    )
